...
public class XzUserGoodsApplyConteoller {
	...
	private XzUserGoodsApplyService xzUserGoodsApplyService;
	   ...
	   public JsonResult findUncheckedApply(String goodsName,Integer pageCurrent) {
		   Integer userId = ShiroUtils.getUser().getId();
		   return new JsonResult(xzUserGoodsApplyService.findUncheckedApply(userId,goodsName,pageCurrent));
	   }
	   ...
	   public JsonResult findcheckedApply(String goodsName,Integer pageCurrent) {
		   Integer userId = ShiroUtils.getUser().getId();
		   return new JsonResult(xzUserGoodsApplyService.findcheckedApply(userId,goodsName,pageCurrent));
	   }
