...
/*
 * Shiro 框架中的Realm对象，通过此对象完成认证和授权。
 * 既包含认证又包含授权
 */
@Service
public class ShiroUserRealm extends AuthorizingRealm {
	...
	public void setCredentialsMatcher(CredentialsMatcher credentialsMatcher) {
		...
		super.setCredentialsMatcher(cMather);//一定要将创建对象传入父类方法
	}
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		SimpleAuthenticationInfo info=new SimpleAuthenticationInfo(
				user,//principal身份
				user.getPassword(),//credentials已经加密的密码
				credentialsSalt,//获取盐值
				getName());//realName
	...
	protected AuthorizationInfo doGetAuthorizationInfo(
		...
		Integer[] array= {};
		List<Integer> menuIds = sysRoleMenuDao.findMenuIdsByRoleIds(
		...
		return info;//info对象会返回给SecurityManager对象，由此对象基于用户权限信息进行授权
	}
